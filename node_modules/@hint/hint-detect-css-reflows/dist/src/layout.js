...
const cssPropertiesObject = (0, utils_fs_1.loadJSONFile)(path.join(__dirname, 'assets', 'CSSReflow.json')) || {};
...
class DetectCssLayoutHint {
    constructor(context) {
        ...
        const formatMessage = (declaration) => {
            ...
            return (0, i18n_import_1.getMessage)('willTriggerLayout', context.language, [propertyName, triggeredCSSChangesArray]);
        };
